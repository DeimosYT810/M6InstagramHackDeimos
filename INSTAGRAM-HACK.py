    ...
    def WifiBruteForce():
        ...
        while connected:
            try:
                ...
                choice = input("See ACC Information (y/N) ? ")
                if choice == "y" or "Y":
                    print(f"[LOADING] Searching for {WIFI} Acc")
                    time.sleep(1)
                ...
                print("[ERROR] Fijate bien si esta bien escrito el txt.")
                main()

    def main():
        time.sleep(1)
        print("\n")
        print("Instagram Hack by Deimos = TOOLS =")
        time.sleep(1)
        print("1 - Sacar informacion de cuenta ")
        print("2 - Ataque a fuerza bruta")
        print("3 - Phising")
        print("0 - Exit")
        a = input("-> ")
        if a == "1":
            if platform.system() == "Linux":
                os.system("Hey bienvenido para continuar pon enter!")
                time.sleep(2)
                main()
            elif platform.system() == "Windows":
                print("Hey! losentimos pero esta herramienta no esta disponible para Windows! :C")
                time.sleep(1)
                main()
